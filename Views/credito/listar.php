    ...
    <main>
        <div class="container-fluid">
            <div class="row">
                ...
                <?php if ($_SESSION['membresiaEstado'] == 1) { ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?php echo base_url(); ?>credito/registrar">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="usuarios">Codigo de Usuario</label><br>
                                        <input id="usuarios"  class="form-control" type="number" name="usuarios" min="1" value="<?php echo $_SESSION['id'];?>"  readonly>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="cantidad">Cantidad</label>
                                        <input id="cantidad" class="form-control" type="number" name="cantidad" min="1" max="5" required placeholder="Cantidad">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="observacion" class="form-control" name="observacion" rows="3" required placeholder="Observacion"></textarea>
                            </div>
