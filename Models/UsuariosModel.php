...
class UsuariosModel extends Mysql{
    ...
    public function insertarUsuarios(string $nombre, string $correo, string $usuario, string $clave, string $rol)
    {
        $return = "";
        $this->nombre = $nombre;
        $this->correo = $correo;
        ...
        $this->clave = $clave;
        $this->rol = $rol;
        $query = "INSERT INTO usuarios( correo, usuario,nombre, clave, rol) VALUES (?,?,?,?,?)";
        $data = array($this->nombre, $this->correo, $this->usuario, $this->clave, $this->rol);
    ...
    public function actualizarUsuarios(string $nombre, string $correo, string $usuario, string $rol, int $id)
    {
        $return = "";
        $this->nombre = $nombre;
        $this->correo = $correo;
        ...
        $this->rol = $rol;
        $this->id = $id;
        $query = "UPDATE usuarios SET nombre=?, correo=?, usuario=?, rol=? WHERE id=?";
        $data = array($this->nombre, $this->usuario,$this->correo,$this->rol, $this->id);
        $resul = $this->update($query, $data);
        $return = $resul;
        return $return;
    }
    public function actualizarUsuariosS(string $membresiaEstado, int $id)
    {
        $userId = $_SESSION['id'];
        ...
        $this->id = $id;
        $query = "UPDATE usuarios SET membresiaEstado=? WHERE id = ?";
        $data = array($this->membresiaEstado, $this->id);
        $resul = $this->update($query, $data);
        $return = $resul;
        return $return;
    }
